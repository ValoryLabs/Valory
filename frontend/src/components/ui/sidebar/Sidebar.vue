...
<template>
  ...
  >
    ...
    <div
      :class="
        cn(
          'relative h-[calc(100dvh-3.5rem)] w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear',
    ...
    <div
      :class="
        cn(
          'fixed inset-y-0 z-10 mt-14 hidden h-[calc(100dvh-3.5rem)] w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
